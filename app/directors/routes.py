...
@director_router.get("/first-name", response_model=list[DirectorSchema])
...
@director_router.get("/last-name", response_model=list[DirectorSchema])
...
@director_router.get("/country", response_model=list[DirectorSchema])
